...
//import 'package:agora1/widgets/call_actions_row.dart';
...
class _VideoCallState extends State<VideoCall> {
  ...
  void startCallTimer() {
    ...
    _callTimer = Timer.periodic(duration, (Timer timer) {
      ...
      if (_localUserJoined && _remoteUid == null && _callDuration >= 20 && !_disconnectCalled) {
        disconnect();
        timer.cancel();
        _disconnectCalled = true;
      }
    ...
    _engine.registerEventHandler(
      RtcEngineEventHandler(
        ...
        onUserJoined: (RtcConnection connection, int remoteUid, int elapsed) {
          ...
          //  _remoteUid = remoteUid;
          //});
          // If the remote user joined, cancel the timer
          //_callTimer.cancel();
        },
    ...
    try {
      ...
      if (_remoteUid != null && _remoteUid != 0) {
        final response = await http.post(
          Uri.parse('https://instamatchonline.com/uservideocallstatus'),
          headers: <String, String>{
            'Content-Type': 'application/json; charset=UTF-8',
          },
          body: jsonEncode({
            'user': widget.user, // Include local user information
            //'remoteUser': _remoteUid, // Include remote user information
    ...
    return Container(
      ...
      Row(
        ...
        children: <Widget>[
          ...
          RawMaterialButton(
            onPressed: () {
              toggleVideo(); // Call your toggleVideo function here
              setState(() {
                // Toggle the local video visibility
